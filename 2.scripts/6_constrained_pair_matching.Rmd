...
We must be careful when we analyze the results as only `r N_matched` treated units were matched: the estimand is not longer the ATT. To know the true causal effect, we must compute the average difference in potential outcomes:
