...
We base our simulation on a dataset that includes all residents of the island of Montreal, Canada, who died from non-accidental causes in the city during the summer periods (June-August) between 1990 and 2007. Daily bservations with missing values were dropped to ease the simulation procedure. We load the environmental dataset `data.rds` located in the `1.data` folder:
