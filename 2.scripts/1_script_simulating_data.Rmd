...
ggsave(
  graph_cov_densities,
  filename = here::here("3.outputs", "2.graphs", "graph_cov_densities"),
  width = 15,
  height = 8,
  units = "cm",
  device = cairo_pdf
...
ggsave(
  graph_stripes_treatment,
  filename = here::here("3.outputs", "2.graphs", "graph_stripes_treatment"),
  width = 15,
  height = 8,
  units = "cm",
  device = cairo_pdf
...
ggsave(
  graph_po_densities,
  filename = here::here("3.outputs", "2.graphs", "graph_po_densities"),
  width = 15,
  height = 8,
  units = "cm",
  device = cairo_pdf
